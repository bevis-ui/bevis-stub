modules.define(
    ...
    describe('EventManager', function () {
        ...
        beforeEach(function () {
            owner = {};
            manager = new EventManager(owner);
        });

        describe('bindTo()', function () {
            it('should bind event listeners to EventEmitter', function () {
            ...
            it('should throw error for unsupported emitter type', function () {
                ...
                }).should.throw(Error).and.throw('Unsupported emitter type');
            });
        ...
        describe('unbindFrom()', function () {
            ...
            it('should unbind event listeners from EventEmitter', function () {
